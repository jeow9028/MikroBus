...
/* ************************** YOURE Ability STUFF ************************************/
	 //Call Function with all the ranges
	  Ranges(Alcohol_val);
...
//	xil_printf("Data TXd \n\r");
 ...
 int Ranges(u32 x){
	 if ((0 <= x) && (x <= 250)){
			  xil_printf ("\e[1;32m You are okay to drive! :D \e[1;37m \r\n");
	...
	//*************************************************************************************
		  ...
		  if ((1000 <= x) && (x <= 1250)){
			  xil_printf ("\e[1;33m You are feeeeeling gooood! But I would wait to drive :) \e[1;37m \r\n");
			  xil_printf("Alcohol Value = %d\n\r", x);
	...
	//*****************************************************************
		  ...
		  if ((2000 <= x) && (x <= 2500)){
			  xil_printf ("\e[1;31m Buddy you're smashed! Don't drive :( \e[1;37m \r\n");
			  xil_printf("Alcohol Value = %d\n\r", x);
			 Over_Write_Buffer(0x07, 0xC0, 0xFF);
		  }

		  if ((2500 <= x) && (x <= 3500)){
			  xil_printf ("\e[1;31m Buddy you're smashed!!!  Don't drive :( It doesn't mean you can't chug another beer! :D \e[1;37m \r\n");
			  xil_printf("Alcohol Value = %d\n\r", x);
